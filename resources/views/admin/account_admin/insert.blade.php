...
@section('page-breadcrumb')
    <ul class="page-breadcrumb">
        ...
        <li>
            <span class="bold">Thêm tài khoản</span>
        </li>
    </ul>
@endsection
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Admin</span>
                    </div>
                </div>

                <div class="portlet-body form">
                    {{Form::open(['action' => 'Admin\AdminController@insert', 'method' => 'POST', 'files' => true, 'id' => 'insert-admin', 'data-toggle'=>'validator'])}}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <select name="role_id" id="role_id" class="form-control">
                                        @foreach($roles as $role)
                                            <option value="{{$role->role_id}}"
                                                    @if ($role->role_id == old('role_id')) selected @endif>
                                                {{$role->name}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="mt-radio-inline">
                                        ...
                                        <label class="mt-radio">
                                            <input type="radio" name="status" id="optionsRadios5" value="-1"> Tạm dừng
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
