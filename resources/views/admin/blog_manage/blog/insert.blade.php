            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Viết bài</span>
                    </div>
                </div>

                <div class="portlet-body form">
                    {{Form::open(['action' => 'Admin\BlogController@insert', 'method' => 'POST', 'files' => true,
                    'id' => 'insert-blog', 'data-toggle'=>'validator'])}}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <select required name="category_id" id="category_id" class="form-control" disabled>
                                        <option value="">Chọn Thể loại</option>
                                        @foreach($blogCategories as $blogCategory)
                                            <option value="{{$blogCategory['category_id']}}"
                                                    data-language="{{$blogCategory['language']}}"
                                                    @if($blogCategory['category_id'] == old('category_id')) selected @endif>{{$blogCategory['name']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <input required type="text" name="slug" value="{{old('slug')}}" id="slug"
                                           class="form-control">
                                </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <input disabled type="text" value="{{get_admin_session()['name']}}"
                                           class="form-control">
                                    <input type="hidden" name="author_id" value="{{get_admin_session()['admin_id']}}"
                                           class="form-control">
                                </div>
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="mt-radio-inline">
                                        <label class="mt-radio">
                                            <input type="radio" name="is_published" value="1" checked=""> Công khai
                                            <span></span>
                                        </label>
                                        <label class="mt-radio">
                                            <input type="radio" name="is_published" value="0"> Riêng tư
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
