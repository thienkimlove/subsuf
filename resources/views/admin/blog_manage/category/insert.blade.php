            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Thêm Thể loại</span>
                    </div>
                </div>

                <div class="portlet-body form">
                    {{Form::open(['action' => 'Admin\BlogCategoryController@insert', 'method' => 'POST', 'files' => true,
                    'id' => 'insert-blog-category', 'data-toggle'=>'validator'])}}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group form-group-sm">
                                    ...
                                    <input required type="text" name="name" value="{{old('name')}}" id="name"
                                           class="form-control">
                                </div>
