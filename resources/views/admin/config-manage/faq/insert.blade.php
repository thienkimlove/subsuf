            ...
            <div class="portlet light form-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Thêm FAQ</span>
                    </div>
                ...
                <div class="portlet-body form">
                    {{Form::open(['action' => 'Admin\FaqController@insert', 'method' => 'POST', 'id' => 'faq-form',
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-10">
                                <input type="number" name="faq_order" value="{{old('faq_order')}}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-10">
                                <textarea name="ask" class="summernote">{{old('ask')}}</textarea>
                            </div>
                        </div>
