...
@section('page-breadcrumb')
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{URL::action('Admin\StaticContentController@policy')}}">Điều khoản</a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
        ...
        <div class="col-md-12">
            <div class="portlet light form-fit bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a type="button" class="btn btn-xs default tooltips m-r-0" title="Về trang Điều khoản"
                           href="{{URL::action('Admin\StaticContentController@terms')}}">
                ...
                <div class="portlet-body form">
                    {{Form::open(['action' => 'Admin\StaticContentController@terms_insert',
                    'method' => 'POST', 'id' => 'terms-form', 'class'=>'form-horizontal form-bordered','data-toggle'=>'validator',
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                <a type="button" class="btn btn-sm green uppercase" id="insert_terms">
                                    Lưu
                                </a>
...
@section('script')
    ...
    <script>
        $("#insert_terms").click(function () {
            var language = $("#language").val();
            $.ajax({
                url: '{{URL::action('Admin\StaticContentController@check_terms')}}',
                type: 'GET',
                data: {
                    'language': language
                },
                ...
                success: function (data) {
                    if (data == 1) {
                        ...
                        toastr.error('Điều khoản đã có ngôn ngữ ' + $("#language").find("option:selected").text(), 'Thông báo');
                        return false;
                    } else {
                        $("#terms-form").submit();
                    }
