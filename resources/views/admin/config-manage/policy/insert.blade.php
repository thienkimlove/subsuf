        ...
        <div class="col-md-12">
            <div class="portlet light form-fit bordered">
                ...
                <div class="portlet-body form">
                    {{Form::open(['action' => 'Admin\StaticContentController@policy_insert',
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                <a type="button" class="btn btn-sm green uppercase" id="insert_policy">
                                    Lưu
                                </a>
...
@section('script')
    ...
    <script>
        $("#insert_policy").click(function () {
            var language = $("#language").val();
            $.ajax({
                url: '{{URL::action('Admin\StaticContentController@check_policy')}}',
                type: 'GET',
                data: {
                    'language': language
                },
                ...
                success: function (data) {
                    if (data == 1) {
                        ...
                        toastr.error('Chính sách bảo mật đã có ngôn ngữ ' + $("#language").find("option:selected").text(), 'Thông báo');
                        return false;
                    } else {
                        $("#policy-form").submit();
                    }
