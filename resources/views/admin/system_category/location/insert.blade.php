...
@section('page-breadcrumb')
    <ul class="page-breadcrumb">
        ...
        <li>
            <span class="bold">Thêm địa điểm</span>
        </li>
    </ul>
@endsection
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Thêm địa điểm</span>
                    </div>
                </div>

                <div class="portlet-body form">
                    {{Form::open(['action' => 'Admin\LocationController@insert', 'method' => 'POST', 'id' => 'insert-location',
                    'data-toggle'=>'validator', 'files' => true,])}}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="form-actions text-right">
                        ...
                        <a role="button" class="btn btn-sm btn-default uppercase"
                           href="{{URL::action('Admin\LocationController@index')}}">
                            Hủy
                        </a>
                    </div>
                    {{Form::close()}}
