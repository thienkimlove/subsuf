...
@section('page-breadcrumb')
    <ul class="page-breadcrumb">
        ...
        <li>
            <span class="bold">Sửa: {{$country->name}}</span>
        </li>
    </ul>
@endsection
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Quốc gia: {{$country->name}}</span>
                    </div>
                </div>

                <div class="portlet-body form">
                    {{Form::open(['action' => ['Admin\CountryController@update', $country->country_id], 'method' => 'POST', 'id' => 'update-country', 'data-toggle'=>'validator'])}}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-12">
