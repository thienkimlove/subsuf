...
@section('page-breadcrumb')
    <ul class="page-breadcrumb">
        ...
        <li>
            <span class="bold">Thông tin: {{$language->name}}</span>
        </li>
    </ul>
@endsection
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">
                            Ngôn ngữ: {{$language->name}} ({{$language->language_code}})
                        </span>
                    </div>
                    <div class="actions">
                        <a type="button" class="btn btn-xs default tooltips m-r-0" title="Về trang Ngôn ngữ"
