                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 footer-block">
                            <h2 class="font-red">{{trans("index.theodoichungtoi")}}</h2>
                            <ul class="social-icons">
                                <li>
                                    <a href="https://www.facebook.com/Subsuf.global/?ref=aymt_homepage_panel"
                                       data-original-title="facebook" class="facebook" target="_blank"></a>
                                </li>

                                <li>
                                    <a href="javascript:;" data-original-title="googleplus" class="linkedin"
                                       target="_blank"></a>
                                </li>
                            </ul>
                            <br>
                            <h2 class="font-red">{{trans("index.lienhe")}}</h2>
                            <address class="margin-bottom-10"> {{trans("index.dienthoai")}}: 0904645593 / 0904534902
                                <br> Email:
