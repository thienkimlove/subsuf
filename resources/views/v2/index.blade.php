                        ...
                        <div class="item">
                            <div class="box_product">
                                ...
                                <div class="info_product">
                                    ...
                                    <a class="link_web" href="{{$saleItem->link}}">{{ parse_url($saleItem->link, PHP_URL_HOST) }}</a>
                                    <div class="price-box">
                        ...
                        <div class="item">
                            <div class="box_product">
                                ...
                                <div class="info_product">
                                    ...
                                    <a class="link_web" href="{{$featureItem->link}}">{{ parse_url($featureItem->link, PHP_URL_HOST) }}</a>
                                    <div class="price-box">
                                 ...
                                 <div class="item">
                                    <div class="box_exhibition">
                                        <div class="image_exhibition">
                                            <a href="#">
                                                <img src="{{url($order->order_images[0]->image)}}"  height="236" width="354" alt="">
                                            </a>
                                        </div>
                                        <div class="info_exhibition">
                                            <div class="wrap_user">
                                                <div class="user_item text-center">
                                                    <a class="img_user" href="{{ url('user-rate', $offer->account->account_id)  }}">
                                                        <img src="{{url($offer->account->avatar)}}" alt="">
                                                    </a>
                                                    <a class="name_user" href="{{ url('user-rate', $offer->account->account_id)  }}">{{$offer->account->first_name}} {{$offer->account->last_name}}</a>
                                                    <span class="add">
                                                         {{$offer->from_location["name"]}}
                                                    </span>
                                                </div>
                                                <div class="user_item">
                                                    <a class="img_user" href="{{ url('user-rate', $order->account->account_id)  }}">
                                                        <img src="{{url($order->account->avatar)}}" alt="">
                                                    </a>
                                                    <a class="name_user" href="{{ url('user-rate', $order->account->account_id)  }}">{{$order->account->first_name}} {{$order->account->last_name}}</a>
                                                    <span class="add">
                                            ...
                                            <div class="wage">
                                                {{trans('index.v2_tiencong')}}: <span>${{$offer->others_fee+$offer->shipping_fee+$offer->tax}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
